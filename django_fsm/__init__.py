...
if typing.TYPE_CHECKING:  # pragma: no cover
    ...
    CharField = models.CharField[typing.Any, typing.Any]
    IntegerField = models.IntegerField[typing.Any, typing.Any]
    ForeignKey = models.ForeignKey[typing.Any, typing.Any]

    _FSMModel = models.Model
    _StateValue: typing.TypeAlias = str | int
    _Permission: typing.TypeAlias = str | Callable[[_FSMModel, UserWithPermissions], bool]
    _Condition: typing.TypeAlias = Callable[[_FSMModel], bool]
...
class Transition:
    def __init__(
        self,
        method: Callable[..., _StateValue | typing.Any],
...
def get_available_FIELD_transitions(instance: _FSMModel, field: FSMFieldMixin) -> Generator[Transition]:  # noqa: N802
    """
...
class FSMMeta:
    ...
    def __init__(self, field: FSMFieldMixin, method: typing.Any) -> None:
        self.field = field
        self.transitions: dict[_StateValue, Transition] = {}  # source -> Transition
    ...
    def add_transition(
        ...
        conditions: list[Callable[[_FSMModel], bool]] = [],
    ...
    def has_transition(self, state: _StateValue) -> bool:
        """
        Lookup if typing.Any transition exists from current model state using current method
        """
    ...
    def has_transition_perm(self, instance: _FSMModel, state: _StateValue, user: UserWithPermissions) -> bool:
        transition = self.get_transition(state)
...
class FSMFieldDescriptor:
    ...
    def __get__(self, instance: _FSMModel, type: typing.Any | None = None) -> typing.Any:  # noqa: A002
        if instance is None:
            return self
        return self.field.get_state(instance)

    def __set__(self, instance: _FSMModel, value: typing.Any) -> None:
...
class FSMFieldMixin(_Field):
    ...
    def __init__(self, *args: typing.Any, **kwargs: typing.Any) -> None:
        ...
        self.transitions: dict[type[_FSMModel], dict[str, typing.Any]] = {}  # cls -> (transitions name -> method)
    ...
    def set_proxy(self, instance: _FSMModel, state: _StateValue) -> None:
        """
        Change class
        """
    ...
    def change_state(self, instance: _FSMModel, method: Incomplete, *args: typing.Any, **kwargs: typing.Any) -> typing.Any:
    ...
    @typing.override
    def contribute_to_class(self, cls: type[_FSMModel], name: str, **kwargs: typing.Any) -> None:  # type: ignore[override]
        self.base_cls = cls
    ...
    def _collect_transitions(self, *args: typing.Any, **kwargs: typing.Any) -> None:
...
class FSMKeyField(FSMFieldMixin, ForeignKey):  # type: ignore[misc]
    ...
    def get_state(self, instance: _FSMModel) -> Incomplete:
...
def transition(
    ...
    on_error: _StateValue | None = None,
    conditions: list[Callable[[typing.Any], bool]] = [],
    ...
    def inner_transition(func: Incomplete) -> Incomplete:
        ...
        @wraps(func)
        def _change_state(instance: _FSMModel, *args: typing.Any, **kwargs: typing.Any) -> Incomplete:
...
def can_proceed(bound_method: Incomplete, check_conditions: bool = True) -> bool:  # noqa: FBT001, FBT002
    """
...
class State:
    def get_state(
        self, model: _FSMModel, transition: Transition, result: typing.Any, args: typing.Any = [], kwargs: typing.Any = {}
    ) -> Incomplete:
...
class GET_STATE(State):  # noqa: N801
    def __init__(self, func: Callable[..., _StateValue | typing.Any], states: Sequence[_StateValue] | None = None) -> None:
        self.func = func
