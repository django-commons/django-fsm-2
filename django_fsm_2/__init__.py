...
def get_available_FIELD_transitions(
    instance: Model, field: FSMFieldMixin
) -> Iterator[Transition]:
    """
    ...
    for transition in transitions.values():
        meta: FSMMeta = transition._django_fsm_2
...
def get_available_user_FIELD_transitions(
    instance: Model, user: AbstractBaseUser, field: FSMFieldMixin
) -> Iterator[Transition]:
    """
...
class FSMMeta:
    ...
    def has_transition_perm(
        self, instance: Model, state: StateValue, user: AbstractBaseUser
    ) -> bool:
        """
...
class FSMFieldMixin:
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        state_choices: list[tuple[StateValue, str, str]] | None = kwargs.pop(
            "state_choices", None
        )
    ...
    def change_state(
        self, instance: Model, method: Callable[..., Any], *args: Any, **kwargs: Any
    ) -> Any:
        """
        ...
        """
        meta: FSMMeta = method._django_fsm_2
            ...
            if next_state is not None:
                if hasattr(next_state, "get_state"):
                    next_state = next_state.get_state(
                        instance, method, result, args=args, kwargs=kwargs
                    )
    ...
    def get_all_transitions(self, instance_cls: type[Model]) -> Iterator[Transition]:
        ...
        for transition_method in transitions.values():
            meta: FSMMeta = transition_method._django_fsm_2
            ...
            return (
                ...
                and (
                    ...
                    or (
                        ...
                        == self.creation_counter  # type: ignore[attr-defined]
                    )
                )
            )
...
def can_proceed(bound_method: Any, check_conditions: bool = True) -> bool:
    ...
    meta: FSMMeta = bound_method._django_fsm_2
