...
DJANGO_FSM_LOG_IGNORED_MODELS = (
    ...
    "tests.testapp.tests.test_async_transitions.AsyncBlogPost",
    "tests.testapp.tests.test_async_transitions.AsyncGetStateModel",
    "tests.testapp.tests.test_async_transitions.AsyncMultiDecoratedModel",
    "tests.testapp.tests.test_async_transitions.AsyncRefreshableProtected",
    "tests.testapp.tests.test_async_transitions.AsyncDeferrableModel",
    "tests.testapp.tests.test_admin_async.AsyncAdminArticle",
